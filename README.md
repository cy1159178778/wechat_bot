...
* 可以根据 [requirements.txt](https://github.com/cy1159178778/wechat_bot/blob/main/requirements.txt) 搭建环境，或者使用 [整合包](https://pan.quark.cn/s/308e1cffaaef) (不熟悉python的建议使用)，提取码：VyRR
